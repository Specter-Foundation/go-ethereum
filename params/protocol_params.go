...
const (
	...
	// MaxCodeSize increased from 24576 (EIP-170 default) to 65536 for Specter chain.
	...
	MaxCodeSize = 65536 // 64KB — allows PoseidonT3 and future large library contracts
